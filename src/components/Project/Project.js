    ...
    render() {
        ...
        var projects = [
            ...
            {   icon: "",
                ...
                techno: [ "Es6", "Prototype", "Promise", "ReactJs", "react-router", "Redux", "Webpack", "Bootstrap", "Mocha", "Enzyme"],
                link: null,
                source: "https://github.com/devSeb/xebia-test",
                img: null
            } ,
            {   icon: "fa fa-android",
                title: "Managing Labs",
                desc: "Demo of a web application with form and manage data with redux.",
                techno: [ "es6", "Promise", "React Js","Redux", "Bootstrap", "Less", "Chart.js", "Gmap.js (Google map)", "Geocoder (Google)"],
                link: "/labs",
